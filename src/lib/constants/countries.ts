...
export const ALL_COUNTRIES: CountryOption[] = [
  ...
  { value: "Armenia", label: "Armenia", region: "Europe" },
  ...
  { value: "Congo (Brazzaville)", label: "Congo (Brazzaville)", region: "Africa" },
  { value: "Congo (Democratic Republic)", label: "Congo (Democratic Republic)", region: "Africa" },
  ...
  { value: "Georgia", label: "Georgia", region: "Europe" },
  ...
  { value: "Macao", label: "Macao", region: "Asia" },
  ...
  { value: "United Arab Emirates", label: "United Arab Emirates (UAE)", region: "Middle East" },
  { value: "United Kingdom", label: "United Kingdom (UK)", region: "Europe" },
  { value: "United States", label: "United States (USA)", region: "North America" },
...
export function getCountriesByRegion(region: string): string[] {
  if (!region || region === "All Regions" || region === "Global") {
    return ALL_COUNTRIES.map((c) => c.value);
  }
  return ALL_COUNTRIES.filter((c) => c.region.toLowerCase() === region.toLowerCase()).map((c) => c.value);
}

export function getRegionByCountry(country: string): string | undefined {
  if (!country) return undefined;
  const match = ALL_COUNTRIES.find(
    (c) => c.value.toLowerCase() === country.toLowerCase() || c.label.toLowerCase().includes(country.toLowerCase())
  );
  return match?.region;
}
