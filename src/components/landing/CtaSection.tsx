  ...
  return (
    <section className="w-full px-6 py-20 sm:py-28 bg-transparent">
      <div className="mx-auto max-w-5xl">
        <div className="relative rounded-4xl bg-[#133020] text-white p-8 sm:p-14 lg:p-16 overflow-hidden shadow-2xl border border-[#FFB347]/30">
          {/* Ambient Lighting Circles */}
          <div className="absolute -top-32 -left-32 w-96 h-96 bg-[#046241]/60 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-[#FFB347]/20 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(circle_at_center,rgba(4,98,65,0.3)_0%,transparent_70%)] pointer-events-none" />

          {/* Foreground Content */}
          <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto">
            {/* Pill */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#046241] border border-[#FFB347]/40 text-[#FFB347] text-xs font-bold uppercase tracking-wider mb-6 shadow-sm">
            ...
            <p className="text-sm sm:text-base text-[#F5EEDB]/80 font-medium leading-relaxed max-w-xl mb-10">
              {locale === "zh"
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              ...
              >
                ...
                <span className="relative z-10 px-8 py-4 rounded-2xl bg-white text-[#133020] font-black text-sm sm:text-base tracking-wide flex-1 sm:flex-none transition-colors group-hover:bg-[#F5EEDB]">
            ...
            {/* Feature Badges */}
            <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-xs text-[#F5EEDB]/70 font-semibold pt-6 border-t border-white/10 w-full">
